...
import { Text, CloseIcon, WarningIcon } from '@marcoslobo/vibookfinance-uikit'
        ...
        {showTokensBuidl && (
          <SectionManage>
            <ButtonText
              ...
              color="warning"
              onClick={() => window.open('https://apeswap.gitbook.io/apeswap-finance/contact-us/buidl-program')}
            >
              <RowFixed>
